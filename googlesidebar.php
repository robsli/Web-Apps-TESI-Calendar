...
$client->setApplicationName("TESI Calendar"); //DON'T THINK THIS MATTERS
$client->setDeveloperKey('AIzaSyAmfEhwr5Z-Zdn5vzONG42j2BRndsrmTLM'); //GET AT AT DEVELOPERS.GOOGLE.COM
